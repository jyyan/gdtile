...
.roads.inline[highway='motorway_link']   { line-color: #ccc; }
.roads.inline[highway='trunk'],
.roads.inline[highway='trunk_link']      { line-color: #ccc; }
...
.roads.inline[highway='tertiary_link']   { line-color: #e0e0a0; }
.roads.inline[highway='cycleway']        { line-color: #fa0; }
...
/* Zoom: 7 */
.roads.inline[highway='cycleway'][zoom>=7]    { line-width: 2; }
...
.roads.outline[highway='cycleway'][zoom>=10]   { line-width: 4; }
.roads.inline[highway='cycleway'][zoom>=10]    { line-width: 2; }
...
.roads.outline[highway='cycleway'][zoom>=13]   { line-width: 5; }
.roads.inline[highway='cycleway'][zoom>=13]    { line-width: 3; }
...
.roads.outline[highway='service'][zoom>=15],
.roads.outline[highway='unclassified'][zoom>=15],
.roads.outline[highway='residential'][zoom>=15]      { line-width: 1; }
.roads.outline[highway='footway'][zoom>=15]         { line-width: 1; }
.roads.outline[highway='cycleway'][zoom>=10]   { line-width: 6; }
.roads.inline[highway='cycleway'][zoom>=10]    { line-width: 4; }
